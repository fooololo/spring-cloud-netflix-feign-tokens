...
/**
 * Same as {@link EnableFeignClients} but with different {@link ImportBeanDefinitionRegistrar}-implementation.<br/>
 * Here {@link OAuth2FeignClientsRegsitrar}.
 *
 * @author  jbellmann
 */
...
@Documented
@Import({ FeignClientsConfiguration.class, OAuth2FeignClientsRegsitrar.class })
public @interface EnableOAuth2FeignClients {
     ...
     *
     * <p>Consider creating a special no-op marker class or interface in each package that serves no purpose other than
